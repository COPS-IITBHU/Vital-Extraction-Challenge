...
def unsupervised_loader(image_dir = "", transform=None, batch_size=16, shuffle=True, num_workers = 4, shape = (1280, 736)):
    ds = UDASegmentationDataset(image_dir=image_dir, transform=transform, shape=shape)
    return DataLoader(ds, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers)
